...
<head>
    ...
    <script src="<?=BASE_URL?>app/assets/js/admin_login.js?v=150620"></script>
    <link href="https://fonts.googleapis.com/css2?family=Nunito+Sans&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="<?=BASE_URL?>app/assets/css/admin_login.css?v=150620">
    <link rel="sortcut icon" href="<?=BASE_URL?>app/assets/images/logo.jpg" type="image/x-icon" />
    <script src="https://www.google.com/recaptcha/api.js?6LcCMaUZAAAAAKEf5ORpRA6xSUMal7Pp3UMbtW3r   "></script>
</head>
<body>
